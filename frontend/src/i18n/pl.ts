export const pl = {
  ...
  // Samsara
  samsaraTab: 'Samsara',
  samsaraVehicleStats: 'Statystyki pojazdów',
  samsaraVehicle: 'Pojazd',
  samsaraOdometer: 'Przebieg (km)',
  samsaraFuel: 'Paliwo (%)',
  samsaraEngine: 'Silnik',
  samsaraEngineOn: 'Włączony',
  samsaraEngineOff: 'Wyłączony',
  samsaraLastUpdate: 'Ostatnia aktualizacja',
  samsaraTachoActivity: 'Aktywność tachografu (Samsara)',
  samsaraDriver: 'Kierowca',
  samsaraState: 'Status',
  samsaraStart: 'Start',
  samsaraEnd: 'Koniec',
  samsaraDuration: 'Czas',
  samsaraManual: 'Ręczny',
  samsaraLoadActivity: 'Pobierz aktywność',
  samsaraNoToken: 'Brak tokenu Samsara API',
  samsaraNoVehicles: 'Brak pojazdów',
  samsaraNoActivity: 'Brak aktywności w wybranym okresie',
  samsaraSelectPeriod: 'Wybierz okres',
  samsaraDriving: 'Jazda',
  samsaraWork: 'Praca',
  samsaraBreakRest: 'Przerwa/Odpoczynek',
  samsaraAvailability: 'Dyspozycyjność',
  samsaraSummary: 'Podsumowanie',
