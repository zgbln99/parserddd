            ...
            <div className="p-4">
              ...
              <div className="flex items-center gap-4 flex-wrap">
                <div className="flex items-center gap-2">
                  ...
                  <label className="text-xs text-muted dark:text-muted-dark">{t('samDayStart')}</label>
                  <select
                    value={dayStart}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <label className="text-xs text-muted dark:text-muted-dark">{t('samDayEnd')}</label>
                  <select
                    value={dayEnd}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            <Card>
              <div className="p-3 text-center">
                <div className="text-xs text-muted dark:text-muted-dark">{t('samVehicles')}</div>
                <div className="text-xl font-bold text-gray-900 dark:text-white mt-1">{summaries.length}</div>
              </div>
            </Card>
            <Card>
              <div className="p-3 text-center">
                <div className="text-xs text-muted dark:text-muted-dark flex items-center justify-center gap-1">
            ...
            <Card>
              <div className="p-3 text-center">
                <div className="text-xs text-muted dark:text-muted-dark">{t('samTotalKm')}</div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <th className="text-left px-3 py-3 font-semibold text-muted dark:text-muted-dark hidden sm:table-cell">
                      {t('samTime')}
                    </th>
                ...
                <tbody>
                    ...
                    return (
                      <>
                        ...
                        >
                          ...
                          <td className="px-3 py-3 text-muted dark:text-muted-dark text-xs" colSpan={1}>
                        ...
                        {isExpanded && vs.days.map((d) => (
                          ...
                          >
                            ...
                            <td className="px-3 py-2 text-muted dark:text-muted-dark font-mono">
                              {d.odoStart} → {d.odoEnd}
                            </td>
                            <td className="px-3 py-2 text-gray-700 dark:text-gray-300">
                              {d.date}
                            </td>
                            <td className="px-3 py-2 text-muted dark:text-muted-dark hidden sm:table-cell">
                  ...
                  <tr className="border-t-2 border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800/50 font-bold">
                    ...
                    <td className="px-3 py-3 text-muted dark:text-muted-dark text-xs">
