            ...
            {navItems.map(({ to, icon: Icon, labelKey }) => (
              ...
              >
                {({ isActive }) => (
                  <>
                    {isActive && (
                      <div className="absolute left-0 top-1/2 -translate-y-1/2 h-6 w-[3px] rounded-r-full bg-blue-600 dark:bg-blue-400 shadow-sm shadow-blue-600/50 dark:shadow-blue-400/50" />
                    )}
                    <div className={clsx(
