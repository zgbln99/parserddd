...
import {
  ...
  Palette, Clock, ShieldCheck, Search, MapPin, Fuel, ShieldAlert, Wrench,
} from 'lucide-react';
...
export function Layout({ children }: { children: ReactNode }) {
  ...
  const vehicleKeys = new Set(['/vehicles', '/map', '/safety', '/diagnostics', '/odometer', '/driver-km', '/fuel-cards', '/toll', '/samsara-km']);
