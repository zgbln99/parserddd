...
/** Jazda / Driving — tachograph disc icon */
export function IconDriving({ size = 14, className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} className={className} fill="currentColor">
      <path fillRule="evenodd" clipRule="evenodd" d="M18.6419 16.4608C19.4995 15.1863 20 13.6516 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 13.8061 4.59854 15.4725 5.60808 16.8115L10.4734 11.5593L11.7267 10.1795L18.6419 16.4608ZM16.9875 18.2554C15.6198 19.3473 13.8861 20 12 20C10.2688 20 8.666 19.4501 7.3568 18.5154L11.8883 13.6236L16.9875 18.2554ZM22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12Z" />
    </svg>
  );
}

/** Praca / Work — tools icon */
...
/** Odpoczynek / Rest — bed icon */
export function IconRest({ size = 14, className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} className={className} fill="currentColor">
      <path d="M5.36842 4V11.2C10.7227 11.2 13.7518 11.2 19.1053 11.2C19.3991 11.2 20.5263 11.2 21 11.2V20H19.1053V13.6L5.36842 13.6V20L3 20V4L5.36842 4Z" />
    </svg>
  );
}

/** Dostępny / Available — square with diagonal line */
export function IconAvailability({ size = 14, className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} className={className} fill="currentColor">
      <path fillRule="evenodd" clipRule="evenodd" d="M19.5858 3H3V19.5856L19.5858 3ZM4.41401 21H21V4.4142L4.41401 21ZM1 1H3H21H23V3V21V23H21H3H1V21V3V1Z" />
    </svg>
  );
}
