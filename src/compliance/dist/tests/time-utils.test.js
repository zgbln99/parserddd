...
import { durationMinutes, findGaps, intersect, overlaps, sortIntervals, sumMinutes, } from "../calculations/time.js";
...
describe("time utilities", () => {
    ...
    it("finds gaps inside a range", () => {
        const gaps = findGaps({ start: new Date("2026-01-01T00:00:00Z"), end: new Date("2026-01-01T10:00:00Z") }, [
