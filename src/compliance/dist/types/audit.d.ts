 ...
 */
export type AuditAction = "EVALUATION_RUN" | "VIOLATION_CREATED" | "VIOLATION_SIGNED" | "VIOLATION_DISPUTED" | "VIOLATION_CORRECTED" | "TIMELINE_NORMALIZED" | "RULES_LOADED" | "FINES_LOADED";
