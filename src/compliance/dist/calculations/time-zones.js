 ...
 */
export function localDateKey(date, time_zone) {
 ...
 */
export function tzOffsetMinutes(date, time_zone) {
    ...
    const localUtc = Date.UTC(Number(lookup.year), Number(lookup.month) - 1, Number(lookup.day), Number(lookup.hour), Number(lookup.minute), Number(lookup.second));
 ...
 */
export function localMidnight(date, time_zone) {
