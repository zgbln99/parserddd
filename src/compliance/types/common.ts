...
export const asDriverId = (s: string): DriverId => s as DriverId;
export const asVehicleId = (s: string): VehicleId => s as VehicleId;
export const asViolationId = (s: string): ViolationId => s as ViolationId;
